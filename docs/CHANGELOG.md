...
[Full Changelog](https://github.com/github/view_component/compare/v2.48.0...HEAD)

- release 2.48.0 [\#1246](https://github.com/github/view_component/pull/1246) (@BlakeWilliams)
- Fix PVC CI [\#1245](https://github.com/github/view_component/pull/1245) (@pouretrebelle)
- Correct path in example test command [\#1240](https://github.com/github/view_component/pull/1240) (@mhw)
- Update the GOV.UK Components URL to new guide [\#1237](https://github.com/github/view_component/pull/1237) (@peteryates)
- :wrench: Add "Wecasa" to "Who uses ViewComponent?" section [\#1233](https://github.com/github/view_component/pull/1233) (@WaKeMaTTa)
- Add Lookbook to Resources docs page [\#1232](https://github.com/github/view_component/pull/1232) (@allmarkedup)
- Fix style in generator docs [\#1228](https://github.com/github/view_component/pull/1228) (@Spone)
- Docs generator namespace [\#1226](https://github.com/github/view_component/pull/1226) (@Spone)
- Setup Appraisal [\#1225](https://github.com/github/view_component/pull/1225) (@Spone)
- Fix ruby 3.0 CI [\#1224](https://github.com/github/view_component/pull/1224) (@Spone)
- \[Fix\] Inner Rack based methods return blank values fixed [\#1221](https://github.com/github/view_component/pull/1221) (@stiig)
- Add generate\_sidecar as config option [\#1218](https://github.com/github/view_component/pull/1218) (@g13ydson)
- add some examples of good/bad code to ViewComponents in Practice [\#1217](https://github.com/github/view_component/pull/1217) (@joelhawksley)
- Add ViewComponent::Collection to @param of \#render\_inline [\#1215](https://github.com/github/view_component/pull/1215) (@yykamei)
- Improved threadsafety [\#1202](https://github.com/github/view_component/pull/1202) (@horiaradu)
- Make ViewComponent::Collection a collection [\#1178](https://github.com/github/view_component/pull/1178) (@sammyhenningsson)
- Support component generator for tailwindcss-rails [\#1098](https://github.com/github/view_component/pull/1098) (@dixpac)
